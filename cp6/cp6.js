    ...
    e.exports.bootstrapJn5168 = function() {
        function e() {
            return a.debug("try to read (updated) NBR file"), (e = t, s(e, "UTF8").then(e => JSON.parse(e)).catch(t => (a.debug(e, " not found, no ipv6 addr found yet", {
                ...
                }(e) || !m ? n(e).catch(e => (p.increaseError(), m = !1, a.error("NBR_ENABLE_DISCOVERY_FAILED", {
                    error: e.message
...
/*    const t = c.jn5168RestIpv6File;
    ...
    e.exports = {    
        ...
        execFile: function(e, t, r) {
            ...
            }) ? n.reject(new Error("All arguments must be a boolean, string or number")) : (i.debug("Run", e, " with arguments:", t), new n((r, n) => {
                let a = "";
                try {
                    const c = o(e, t, s, e => {
                        null === e ? r(a) : n(e)
...
//            AllFunctions(0)("Function 92").debug("getScenarioViewStructure xxx",xxx);
    ...
    e.exports = {
        trigger: function(e, t) {
            metaLog({type:LOG_TYPE.VERBOSE,content:"Function 144 - Trigger IR "+e.name});            
...
return this._syncFileList();
    ...
    p.prototype._retryPostAfterDelay = function(e, t, r) {
    ...
    }, p.prototype._postRequest = function(e, t, r,xx) {
        ...
        const nx = this.queuePromise.then(() => this._postRequestHelper(e, t, r,xx));
        return this.queuePromise = nx.catch(() => {}), nx
    }, p.prototype._postRequestHelper = function(e, t, r,xx) {
        a.debug("send Payload to NBR (Now broadlink)", {
            path: e,command: xx.name
        });
        ...
        BrainBroadLinkUri=BrainBroadLinkUri+"&cmd="+xx.name
        AllFunctions(0)("Function 288").debug("http-call to broadlink2:",BrainBroadLinkUri)
        //return i.resolve();
        }
        const o = n({
            //uri: this.baseUrl + e,
    ...
    }, p.prototype.sendIr = function(e, t, r, n, o,xx) {
        a.debug("288 sendir cmd",xx)
    ...
    a.prototype._write = function(e,xx) {
        ...
        const t = e.getFrequency(),
            ...
            c = e.getValues().join("."),
            u = e.durationMs();
        return e.isValid() ? s.sendIr(t, r, a, c, u,xx) : (i.increaseCounter("irproxy-invalid-payload"), o.error("IR_PAYLOAD_INVALID", {
            duration: u,
            repeat: r,
            offset: a,
            freq: t
    ...
    }, a.prototype.send = function(e,xx) {
        AllFunctions(0)("Function 309").debug("IRProxy send",xx);
        return i.increaseCounter("irproxy-send-started"), this._enqueue(t => t.then(() => this._write(e,xx)).catch(e => (i.increaseCounter("irproxy-send-failed"), o.warn("IR_SEND_FAILED", e.message || ""), n.reject(e))))
    ...
    u.prototype._sendCommand = function(e, t) {
        AllFunctions(0)("Function 310").debug("IRBlaster",e);
        let r = n.resolve();
        let xx = e;
        return e.payload.forEach(e => {
            "payloads" in e ? r = r.then(() => {
                const r = new s(e);
                AllFunctions(0)("Function 310").debug("IRBlaster send part of command",e,xx);

                return r.getType() === c.IR_PAYLOAD_TYPE_NOP ? (o.debug("ignore NOP payloads"), n.resolve()) : this.irProxy.send(r.getIrMessage(t),e)
...
*/ 
    ...
    o.param("project_key", function(e, t, r, n) {
        ...
        AllFunctions(0)("Function 487").debug("Discover/:sourcename/:adaptername")
        const n = u.getRequestParameter(e, "sourceName", l),
            o = u.getRequestParameter(e, "adapterName", l);
